...
export function InterrogationView({ resetKey = 0 }: { resetKey?: number }) {
  ...
  const [passage, setPassage] = useState({ text: "", source: "" });
  useEffect(() => {
    setIndex(0); setAnswer(""); setResponses([]); setComplete(false); setPassage({ text: "", source: "" });
